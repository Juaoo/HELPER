...
var esBot = {
        ...
        room: {        
            ...
            roulette: {
                ...
                startRoulette: function(){
                    ...
                    API.sendChat("/me A roleta foi iniciada. Digite !join para participar!");
                },
        ...
        chatUtilities: {        
            ...
            commandCheck: function(chat){
                ...
                switch(cmd){
                    ...
                    case '!portugues':          esBot.commands.portuguesCommand.functionality(chat, '!portugues');                  executed = true; break;
        ...
        startup: function(){
            ...
            API.sendChat('/cap 1');
            API.setVolume(0);
            API.sendChat('/me HELPER v1.1.21 ligado!');
        },                        
        commands: {        
                ...
                portuguesCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var ch = '/me @' + name + ' ';
                                    switch(lang){
                                        case 'en': ch += 'Please, speak Portuguese.'; break;
                                        case 'da': ch += 'Vær venlig at tale portugisisk.'; break;
                                        case 'de': ch += 'Bitte sprechen Portugiesisch.'; break;
                                        case 'es': ch += 'Por favor, hable Portugués.'; break;
                                        case 'fr': ch += 'Parlez portugais, s\'il vous plaît.'; break;
                                        case 'nl': ch += 'Spreek Portugees, alstublieft.'; break;
                                        case 'pl': ch += 'Proszę mówić po portugalsku.'; break;
                                        case 'pt': ch += 'Por favor, fale Português'; break;
                                        case 'sk': ch += 'Hovorte po portugalsko, prosím.'; break;
                                        case 'cs': ch += 'Mluvte prosím portugalštině.'; break;
                                        case 'sr': ch += 'Молим Вас, говорите Португуесе.'; break;                                  
                                    }
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.room.roulette.rouletteStatus){
                                        ...
                                        API.sendChat("/me @" + chat.from + " entrou na roleta! (digite !leave parar sair)");
                                    }
                                };                              
                        },
                },
                ...
                killCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    storeToStorage();
                                    API.sendChat('/me HELPER desligado.');
                                    esBot.disconnectAPI();
                ...
                sourceCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    API.sendChat('/me HELPER criado por ' + esBot.creator + ' - https://github.com/motelbible/farofaBot');
                                };                              
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.motdEnabled){
                                        ...
                                        API.sendChat('/me AR desativada.');
                                    }
                                    else{
                                        esBot.roomSettings.motdEnabled = !esBot.roomSettings.motdEnabled;
                                        API.sendChat('/me AR ativada.');
                                    }
                                };                              
                        },
                },
